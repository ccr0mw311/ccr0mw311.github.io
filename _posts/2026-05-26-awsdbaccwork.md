...
![Installation of kiro](/assets/img/posts/install.png)

![Kiro](/assets/img/posts/kiro.png)
...
![EC2 inquiry](/assets/img/posts/ec2inst.png)
...
![Oracle tools](/assets/img/posts/oracletools.png)

![SQL command](/assets/img/posts/sqlcommand.png)

![SQL script](/assets/img/posts/sqlscript.png)
...
![Configure DMS migration](/assets/img/posts/configuredmsmigration.png)

![Create migration](/assets/img/posts/createmigration.png)

For the target database, I selected Amazon Aurora PostgreSQL. Using Kiro, I continued setting up the migration project and configuring the target environment. I also saw the AWS DMS Instance profiles and Data providers that Kiro automatically created during the setup.

![Instance profiles](/assets/img/posts/ip.png)

![Data providers](/assets/img/posts/dp.png)
